...
export interface FBO extends DrawTarget {
...
export default function createFBO(gl: WebGLContext, width: number, height: number, internalFormat: number, format: number, type: number, param: number): FBO {
